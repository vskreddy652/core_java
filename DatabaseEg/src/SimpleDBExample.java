...
public class SimpleDBExample {
	...
	static final String DB_URL = "jdbc:mysql://127.0.0.1:3316/abcd";
	// 127.0.0.1
	...
	public static void main(String[] args) {
		...
		// SQL Injection
			...
			if(stmt.executeUpdate("update simple set salary = salary*1.2")>0)
			{
	...
	static void  displayRecords(Statement stmt) throws SQLException
	{
		...
		//executeUpdate() is for update, delete, insert sql statements
